package com.todoapp.todo.core.generic;;
...
public abstract class AbstractExtendedServiceImpl<T extends ExtendedEntity> implements ExtendedService<T> {

    protected final ExtendedRepository<T> repository;
    protected final Logger logger;

    protected AbstractExtendedServiceImpl(ExtendedRepository<T> repository, Logger logger) {
